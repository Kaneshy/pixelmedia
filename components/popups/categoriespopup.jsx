...
const Categoriespopup = ({ isopen, setisopen }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 overflow-auto">
            ...
            <form
                ref={formRef}
                action={addnewcategories} className="text-white uppercase nerko-one-regular  centered-div flex flex-col gap-y-4 p-6 bg-zinc-950 rounded-md shadow-lg">
                <div
